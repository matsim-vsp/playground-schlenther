 ...
 *
 */
class BerlinOfflineAirPollutionAnalysisByEngineInformation implements MATSimAppCommand {

    private static final Logger log = LogManager.getLogger(BerlinOfflineAirPollutionAnalysisByEngineInformation.class);
    ...
    public static void main(String[] args) throws IOException {
        new BerlinOfflineAirPollutionAnalysisByEngineInformation().execute(args);
    }
    ...
    private void process(Config config, Scenario scenario) throws IOException {
        ...
        String outputNetworkFile = analysisOutputDirectory + runId + ".emissionNetwork_osmMapping.xml.gz";
...
//		eConfig.setHbefaRoadTypeSource(HbefaRoadTypeSource.fromLinkAttributes);
    ...
    private void prepareVehicleTypes(Scenario scenario) {
        for (VehicleType type : scenario.getVehicles().getVehicleTypes().values()) {
            ...
            } else if (type.getId().toString().equals("defaultVehicleType")){           // only DRT vehicles have defaultVehicleType
