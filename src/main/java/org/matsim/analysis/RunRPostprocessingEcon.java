...
public class RunRPostprocessingEcon {
    ...
    public RunRPostprocessingEcon(String runDirectory, String runId, String inner_city_shp, String berlin_shp, String pr_stations, String rScriptCommand, String base_runDirectory, String base_runId) {
    ...
    public void run() {
        ...
        try {
            ...
            String[] commands = {
                    INPUT_RSCRIPTCOMMAND, "src/main/R/differences_accidents.R", INPUT_RUNDIRECTORY, INPUT_RUNID, INPUT_BASE_RUNDIRECTORY, INPUT_BASE_RUNID,
                    INPUT_RSCRIPTCOMMAND, "src/main/R/differences_airPollution.R", INPUT_RUNDIRECTORY, INPUT_RUNID, INPUT_BASE_RUNDIRECTORY, INPUT_BASE_RUNID,
                    INPUT_RSCRIPTCOMMAND, "src/main/R/differences_noise.R", INPUT_RUNDIRECTORY, INPUT_RUNID, INPUT_BASE_RUNDIRECTORY, INPUT_BASE_RUNID,
            };

            for (int i = 0; i < commands.length; i += 6) {

                String[] command = { commands[i], commands[i + 1], commands[i + 2], commands[i + 3], commands[i+4], commands[i+5]};
